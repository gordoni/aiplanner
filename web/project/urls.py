...
urlpatterns = patterns('',
    ...
    url(r'^calculators/alloc$', 'aacalc.views.alloc.alloc', {'mode': 'aa'}, name='start_alloc'),
    url(r'^calculators/allocn$', 'aacalc.views.alloc.alloc', {'mode': 'number'}, name='start_allocn'),
