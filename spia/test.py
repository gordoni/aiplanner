...
if __name__ == '__main__':
    ...
    life_table_iam = LifeTable('iam2012-basic', 'male', 65)
    ...
    print('Single:')
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 0, price_adjust = 'all').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 0, price_adjust = 'payout').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 0, price_adjust = 'calendar').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 1.5, price_adjust = 'all').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 1.5, price_adjust = 'payout').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 1.5, price_adjust = 'calendar').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 18, price_adjust = 'all').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 18, price_adjust = 'payout').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, payout_delay = 18, price_adjust = 'calendar').premium())

    print('Couple:')
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 0, payout_fraction = 0.6, price_adjust = 'all').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 0, payout_fraction = 0.6, price_adjust = 'payout').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 0, payout_fraction = 0.6, price_adjust = 'calendar').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 1.5, payout_fraction = 0.6, price_adjust = 'all').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 1.5, payout_fraction = 0.6, price_adjust = 'payout').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 1.5, payout_fraction = 0.6, price_adjust = 'calendar').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 18, payout_fraction = 0.6, price_adjust = 'all').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 18, payout_fraction = 0.6, price_adjust = 'payout').premium())
    p(IncomeAnnuity(yield_curve_real, life_table_ssa, life_table2 = life_table2_ssa, payout_delay = 18, payout_fraction = 0.6, price_adjust = 'calendar').premium())
    ...
    premium4 = ia.premium()
    p(premium4)
    premium5 = IncomeAnnuity(yield_curve_fixed, life_table_ssa_70, life_table2 = life_table2_ssa_65, payout_delay = 1.5, payout_fraction = 0.5, price_adjust = 'all', date_str = '2022-06-10', schedule = lambda y: 4).premium()
    p(premium5)
    print(abs(premium5 - premium4) < 1e-9)
