...
public class Metrics implements Cloneable
{
        ...
        public Metrics(double tw_goal, double ntw_goal, double floor_goal, double upside_goal, double consume_goal, double inherit_goal, double combined_goal, double tax_goal, double wer, double cost, double human_capital)
        {
                ...
                metrics[MetricsEnum.HUMAN_CAPITAL.ordinal()] = human_capital;
        }
