...
png(filename = paste(prefix, 'aa.png', sep=''), width=250, height=200, pointsize=10, bg='transparent')
par(mar=c(0,0,0,0))
...
png(filename = paste(prefix, 'alloc.png', sep=''), width=800, height=200, pointsize=10, bg='transparent')
par(mar=c(2,0,0,0))
