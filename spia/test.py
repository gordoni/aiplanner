...
if __name__ == '__main__':
    ...
    premium6 = ia.premium()
    p(premium6)
    premium7 = IncomeAnnuity(yield_curve_fixed, life_table_ssa_70, life_table2 = life_table2_ssa_65, payout_delay = 1.5, payout_fraction = 0.5, price_adjust = 'all', date_str = '2022-06-10', schedule = lambda y: 4).premium()
    p(premium7)
